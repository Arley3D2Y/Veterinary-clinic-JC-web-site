...
public class DatabaseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        clienteRepository.save(new Cliente("Natalia Martínez", "8901248", "natalia.martinez@gmail.com", "3008901248",
        ...
        clienteRepository.save(new Cliente("Manuel Martínez", "9012359", "manuel.martinez@gmail.com", "3009012359",
    ...
    private void asignarMascotasAClientes(List<Cliente> clientes, List<Mascota> mascotas) {
        ...
        for (Cliente cliente : clientes) {
            if (mascotasDisponibles.size() < 2) {
                throw new IllegalStateException("No hay suficientes mascotas disponibles para asignar.");
            }
